...
- Create an analysis note: `reviews/feat-t10-native-unfold-poc__analysis.md`.
- Analysis checklist:
...
Deliverables
- `reviews/feat-t10-native-unfold-poc__analysis.md` (mandatory analysis + decision record).
