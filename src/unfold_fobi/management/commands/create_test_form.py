...
from fobi.contrib.apps.drf_integration.form_elements.fields.date.base import (
    DateSelectPlugin,
)
from fobi.contrib.apps.drf_integration.form_elements.fields.email.base import (
    EmailInputPlugin,
)
from fobi.contrib.apps.drf_integration.form_elements.fields.integer.base import (
    IntegerInputPlugin,
)
from fobi.contrib.apps.drf_integration.form_elements.fields.select.base import (
    SelectInputPlugin,
)
from fobi.contrib.apps.drf_integration.form_elements.fields.text.base import (
    TextInputPlugin,
)
from fobi.contrib.apps.drf_integration.form_elements.fields.textarea.base import (
    TextareaPlugin,
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            self.stdout.write(
                self.style.WARNING(
                    f'Form "{form_entry.name}" already exists. Updating...'
                )
            )
        ...
        self.stdout.write(self.style.SUCCESS(f"Form slug: {form_slug}"))
        self.stdout.write(
            self.style.SUCCESS(f"API endpoint: /api/fobi-form-entry/{form_slug}/")
        )
